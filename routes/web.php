...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth.admin')->group(function () {
        ...
        Route::get('/staff/{staff}/edit', [AdminPortalController::class, 'editStaff'])->name('staff.edit');
        Route::put('/staff/{staff}', [AdminPortalController::class, 'updateStaff'])->name('staff.update');
        Route::delete('/staff/{staff}', [AdminPortalController::class, 'destroyStaff'])->name('staff.destroy');
...
Route::prefix('customer')->name('customer.')->group(function () {
    Route::middleware('guest:customer')->group(function () {
        ...
        Route::post('/register/send-phone-code', [\App\Http\Controllers\Auth\RegistrationPhoneController::class, 'send'])->middleware('throttle:registration-sms')->name('register.phone.send');
        Route::post('/register/verify-phone-code', [\App\Http\Controllers\Auth\RegistrationPhoneController::class, 'verify'])->middleware('throttle:registration-phone-code')->name('register.phone.verify');
