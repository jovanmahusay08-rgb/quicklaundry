...
class CustomerLoginController extends Controller
{
    ...
    public function register(Request $request, \App\Services\RegistrationPhoneVerification $verification)
    {
        ...
        $customer = $verification->register($request, $data['phone'], fn () => \Illuminate\Support\Facades\DB::transaction(function () use ($data) {
